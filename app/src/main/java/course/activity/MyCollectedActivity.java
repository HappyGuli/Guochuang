...
public class MyCollectedActivity extends ActionBarActivity {
    ...
    private void initDdata() {
        ...
        datas = new ArrayList<CollectItemBean>();

        for(int i=0;i<5;i++){

            CollectItemBean tem= new CollectItemBean();
    ...
    private class MyQuestionRecyclerViewAdapter extends RecyclerView.Adapter<MyQuestionHolder> {
        ...
        //构造函数
        public MyQuestionRecyclerViewAdapter(Context context, List<CollectItemBean> datas) {
            super();
    ...
    private class MyQuestionHolder extends RecyclerView.ViewHolder{
        ...
        public MyQuestionHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    //测试
                    Toast.makeText(MyCollectedActivity.this, "你点击的收藏是" +
        ...
        public void SetDataAndRefreshUI(CollectItemBean bean){
